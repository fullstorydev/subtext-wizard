...
const RAW_ART = [
  ...
  '              subte                       subte',
  '            subte                           subte',
  '       subte             subtextsub              subte',
  '    subt               subtextsubtexts               subt',
  '   s                   subtextsubtextsubte               s',
  '   s             s         subtextsubtextsub             s',
  '   s             subtex         subtextsubt              s',
  '   s             subtextsub       subte                  s',
  '   s             subtextsubtex                           s',
  '   s             subtextsubtextsubt                      s',
  '   s              subtextsubtextsubtex                   s',
  '   s                  subtextsubtextsubtex               s',
  '   s                    subtextsubtextsubtext            s',
  '   s                         subtextsubtextsu            s',
  '   s                   subt      subtextsubte            s',
  '   s               subtextsub        subtexts            s',
  '   s             subtextsubtextsub        sub            s',
  '   s              subtextsubtextsubtex                   s',
  '    subt              subtextsubtextsub              subt',
  '       subte             subtextsubte            subte',
  '            subte                           subte',
  '              subte                       subte',
  '                  subte               subte',
  '                       subte     subte',
